...
<p>Ha sikeresen teljesítitek a SCUP Schoolt és határidőre beadjátok a projekteteket, <strong>minden csapattag 10 SZTE Junior Akadémia felvételi pluszpontot szerezhet</strong>.</p>

<div class="course-benefit__footer">
<a class="course-benefit__footer-link" href="course/how-course-works.html#dijazas"><img src="assets/logos/ja_logo_magenta_blue_fekvo_large.jpg" alt="SZTE Junior Akadémia"><span>Felvételi pontokkal kapcsolatos részletek</span></a>
</div>
...
homepage_modules <- data.frame(
  ...
  project_phase = c(
    ...
    "A kész projektből meggyőző bemutatást építetek: elkészítitek a pitch-et, a onepager első változatát és a vizuális irányt.",
